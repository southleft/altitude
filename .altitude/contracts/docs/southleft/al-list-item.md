<!-- GENERATED by scripts/contracts/build-component-docs.mjs from al-list-item.contract.json + the southleft parity manifest — do not hand-edit; run `pnpm contracts:docs:sl` -->
...
- [Open in Figma](https://www.figma.com/design/jwNINBLB0oBnxx3MQK9gr3/?node-id=3543-47175)
...
Source contract: `.altitude/contracts/southleft/al-list-item.contract.json`.
