<!-- GENERATED by scripts/contracts/build-component-docs.mjs from al-heading.contract.json + the southleft parity manifest — do not hand-edit; run `pnpm contracts:docs:sl` -->
...
- Node id: `10:1926` (pinned)
- [Open in Figma](https://www.figma.com/design/rdhBS9t89V42E7EfiPjmSa/?node-id=10-1926)
...
Source contract: `.altitude/contracts/southleft/al-heading.contract.json`.
