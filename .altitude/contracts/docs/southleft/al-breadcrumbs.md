<!-- GENERATED by scripts/contracts/build-component-docs.mjs from al-breadcrumbs.contract.json + the southleft parity manifest — do not hand-edit; run `pnpm contracts:docs:sl` -->
...
- [Open in Figma](https://www.figma.com/design/jwNINBLB0oBnxx3MQK9gr3/?node-id=3558-60804)
...
`--al-theme-border-radius-role-action`, `--al-theme-color-background-transparent-default`, `--al-theme-color-content-neutral-default`, `--al-theme-color-content-neutral-weak`, `--al-theme-space-xs`, `--al-theme-space-xxs`, `--al-theme-typography-body-lg`, `--al-theme-typography-body-lg-letter-spacing`

---

Source contract: `.altitude/contracts/southleft/al-breadcrumbs.contract.json`.
