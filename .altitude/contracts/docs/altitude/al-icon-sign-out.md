<!-- GENERATED by scripts/contracts/build-component-docs.mjs from al-icon-sign-out.contract.json + the altitude parity manifest — do not hand-edit; run `pnpm contracts:docs` -->

# al-icon-sign-out — Icon Sign Out
...
No Figma component set is mapped for `al-icon-sign-out` in the **Altitude Design System** parity manifest (parity status: `missing-in-figma`). Map one in Figma, then run `pnpm run parity:seed`.
...
- Import: `@southleft/al-web-components/components/icon/icons/sign-out.ts`
- Tag: `al-icon-sign-out`
...
Source contract: `.altitude/contracts/altitude/al-icon-sign-out.contract.json`.
