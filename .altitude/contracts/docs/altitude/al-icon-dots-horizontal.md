<!-- GENERATED by scripts/contracts/build-component-docs.mjs from al-icon-dots-horizontal.contract.json + the altitude parity manifest — do not hand-edit; run `pnpm contracts:docs` -->

# al-icon-dots-horizontal — Icon Dots Horizontal
...
No Figma component set is mapped for `al-icon-dots-horizontal` in the **Altitude Design System** parity manifest (parity status: `missing-in-figma`). Map one in Figma, then run `pnpm run parity:seed`.
...
- Import: `@southleft/al-web-components/components/icon/icons/dots-horizontal.ts`
- Tag: `al-icon-dots-horizontal`
...
Source contract: `.altitude/contracts/altitude/al-icon-dots-horizontal.contract.json`.
