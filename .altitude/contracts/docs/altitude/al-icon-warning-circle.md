<!-- GENERATED by scripts/contracts/build-component-docs.mjs from al-icon-warning-circle.contract.json + the altitude parity manifest — do not hand-edit; run `pnpm contracts:docs` -->

# al-icon-warning-circle — Icon Warning Circle
...
No Figma component set is mapped for `al-icon-warning-circle` in the **Altitude Design System** parity manifest (parity status: `missing-in-figma`). Map one in Figma, then run `pnpm run parity:seed`.
...
- Import: `@southleft/al-web-components/components/icon/icons/warning-circle.ts`
- Tag: `al-icon-warning-circle`
...
Source contract: `.altitude/contracts/altitude/al-icon-warning-circle.contract.json`.
