<!-- GENERATED by scripts/contracts/build-component-docs.mjs from al-icon-dots-vertical.contract.json + the altitude parity manifest — do not hand-edit; run `pnpm contracts:docs` -->

# al-icon-dots-vertical — Icon Dots Vertical
...
No Figma component set is mapped for `al-icon-dots-vertical` in the **Altitude Design System** parity manifest (parity status: `missing-in-figma`). Map one in Figma, then run `pnpm run parity:seed`.
...
- Import: `@southleft/al-web-components/components/icon/icons/dots-vertical.ts`
- Tag: `al-icon-dots-vertical`
...
Source contract: `.altitude/contracts/altitude/al-icon-dots-vertical.contract.json`.
