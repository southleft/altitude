<!-- GENERATED by scripts/contracts/build-component-docs.mjs from al-icon-layout-masonry.contract.json + the altitude parity manifest — do not hand-edit; run `pnpm contracts:docs` -->

# al-icon-layout-masonry — Icon Layout Masonry
...
No Figma component set is mapped for `al-icon-layout-masonry` in the **Altitude Design System** parity manifest (parity status: `missing-in-figma`). Map one in Figma, then run `pnpm run parity:seed`.
...
- Import: `@southleft/al-web-components/components/icon/icons/layout-masonry.ts`
- Tag: `al-icon-layout-masonry`
...
Source contract: `.altitude/contracts/altitude/al-icon-layout-masonry.contract.json`.
