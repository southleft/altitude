<!-- GENERATED by scripts/contracts/build-component-docs.mjs from al-icon-search.contract.json + the altitude parity manifest — do not hand-edit; run `pnpm contracts:docs` -->

# al-icon-search — Icon Search
...
No Figma component set is mapped for `al-icon-search` in the **Altitude Design System** parity manifest (parity status: `missing-in-figma`). Map one in Figma, then run `pnpm run parity:seed`.
...
- Import: `@southleft/al-web-components/components/icon/icons/search.ts`
- Tag: `al-icon-search`
...
Source contract: `.altitude/contracts/altitude/al-icon-search.contract.json`.
