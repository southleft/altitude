<!-- GENERATED by scripts/contracts/build-component-docs.mjs from al-icon-support.contract.json + the altitude parity manifest — do not hand-edit; run `pnpm contracts:docs` -->

# al-icon-support — Icon Support
...
No Figma component set is mapped for `al-icon-support` in the **Altitude Design System** parity manifest (parity status: `missing-in-figma`). Map one in Figma, then run `pnpm run parity:seed`.
...
- Import: `@southleft/al-web-components/components/icon/icons/support.ts`
- Tag: `al-icon-support`
...
Source contract: `.altitude/contracts/altitude/al-icon-support.contract.json`.
