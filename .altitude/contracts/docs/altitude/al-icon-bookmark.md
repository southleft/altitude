<!-- GENERATED by scripts/contracts/build-component-docs.mjs from al-icon-bookmark.contract.json + the altitude parity manifest — do not hand-edit; run `pnpm contracts:docs` -->

# al-icon-bookmark — Icon Bookmark
...
No Figma component set is mapped for `al-icon-bookmark` in the **Altitude Design System** parity manifest (parity status: `missing-in-figma`). Map one in Figma, then run `pnpm run parity:seed`.
...
- Import: `@southleft/al-web-components/components/icon/icons/bookmark.ts`
- Tag: `al-icon-bookmark`
...
Source contract: `.altitude/contracts/altitude/al-icon-bookmark.contract.json`.
