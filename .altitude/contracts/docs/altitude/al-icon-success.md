<!-- GENERATED by scripts/contracts/build-component-docs.mjs from al-icon-success.contract.json + the altitude parity manifest — do not hand-edit; run `pnpm contracts:docs` -->

# al-icon-success — Icon Success
...
No Figma component set is mapped for `al-icon-success` in the **Altitude Design System** parity manifest (parity status: `missing-in-figma`). Map one in Figma, then run `pnpm run parity:seed`.
...
- Import: `@southleft/al-web-components/components/icon/icons/success.ts`
- Tag: `al-icon-success`
...
Source contract: `.altitude/contracts/altitude/al-icon-success.contract.json`.
