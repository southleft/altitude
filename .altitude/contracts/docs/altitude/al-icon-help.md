<!-- GENERATED by scripts/contracts/build-component-docs.mjs from al-icon-help.contract.json + the altitude parity manifest — do not hand-edit; run `pnpm contracts:docs` -->

# al-icon-help — Icon Help
...
No Figma component set is mapped for `al-icon-help` in the **Altitude Design System** parity manifest (parity status: `missing-in-figma`). Map one in Figma, then run `pnpm run parity:seed`.
...
- Import: `@southleft/al-web-components/components/icon/icons/help.ts`
- Tag: `al-icon-help`
...
Source contract: `.altitude/contracts/altitude/al-icon-help.contract.json`.
