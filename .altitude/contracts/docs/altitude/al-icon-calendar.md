<!-- GENERATED by scripts/contracts/build-component-docs.mjs from al-icon-calendar.contract.json + the altitude parity manifest — do not hand-edit; run `pnpm contracts:docs` -->

# al-icon-calendar — Icon Calendar
...
No Figma component set is mapped for `al-icon-calendar` in the **Altitude Design System** parity manifest (parity status: `missing-in-figma`). Map one in Figma, then run `pnpm run parity:seed`.
...
- Import: `@southleft/al-web-components/components/icon/icons/calendar.ts`
- Tag: `al-icon-calendar`
...
Source contract: `.altitude/contracts/altitude/al-icon-calendar.contract.json`.
