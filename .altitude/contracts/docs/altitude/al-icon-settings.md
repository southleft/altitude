<!-- GENERATED by scripts/contracts/build-component-docs.mjs from al-icon-settings.contract.json + the altitude parity manifest — do not hand-edit; run `pnpm contracts:docs` -->

# al-icon-settings — Icon Settings
...
No Figma component set is mapped for `al-icon-settings` in the **Altitude Design System** parity manifest (parity status: `missing-in-figma`). Map one in Figma, then run `pnpm run parity:seed`.
...
- Import: `@southleft/al-web-components/components/icon/icons/settings.ts`
- Tag: `al-icon-settings`
...
Source contract: `.altitude/contracts/altitude/al-icon-settings.contract.json`.
