<!-- GENERATED by scripts/contracts/build-component-docs.mjs from al-icon-chevron-left.contract.json + the altitude parity manifest — do not hand-edit; run `pnpm contracts:docs` -->

# al-icon-chevron-left — Icon Chevron Left
...
No Figma component set is mapped for `al-icon-chevron-left` in the **Altitude Design System** parity manifest (parity status: `missing-in-figma`). Map one in Figma, then run `pnpm run parity:seed`.
...
- Import: `@southleft/al-web-components/components/icon/icons/chevron-left.ts`
- Tag: `al-icon-chevron-left`
...
Source contract: `.altitude/contracts/altitude/al-icon-chevron-left.contract.json`.
