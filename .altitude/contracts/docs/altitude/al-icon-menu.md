<!-- GENERATED by scripts/contracts/build-component-docs.mjs from al-icon-menu.contract.json + the altitude parity manifest — do not hand-edit; run `pnpm contracts:docs` -->

# al-icon-menu — Icon Menu
...
No Figma component set is mapped for `al-icon-menu` in the **Altitude Design System** parity manifest (parity status: `missing-in-figma`). Map one in Figma, then run `pnpm run parity:seed`.
...
- Import: `@southleft/al-web-components/components/icon/icons/menu.ts`
- Tag: `al-icon-menu`
...
Source contract: `.altitude/contracts/altitude/al-icon-menu.contract.json`.
