<!-- GENERATED by scripts/contracts/build-component-docs.mjs from al-icon-user.contract.json + the altitude parity manifest — do not hand-edit; run `pnpm contracts:docs` -->

# al-icon-user — Icon User
...
No Figma component set is mapped for `al-icon-user` in the **Altitude Design System** parity manifest (parity status: `missing-in-figma`). Map one in Figma, then run `pnpm run parity:seed`.
...
- Import: `@southleft/al-web-components/components/icon/icons/user.ts`
- Tag: `al-icon-user`
...
Source contract: `.altitude/contracts/altitude/al-icon-user.contract.json`.
