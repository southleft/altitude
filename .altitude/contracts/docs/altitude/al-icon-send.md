<!-- GENERATED by scripts/contracts/build-component-docs.mjs from al-icon-send.contract.json + the altitude parity manifest — do not hand-edit; run `pnpm contracts:docs` -->

# al-icon-send — Icon Send
...
No Figma component set is mapped for `al-icon-send` in the **Altitude Design System** parity manifest (parity status: `missing-in-figma`). Map one in Figma, then run `pnpm run parity:seed`.
...
- Import: `@southleft/al-web-components/components/icon/icons/send.ts`
- Tag: `al-icon-send`
...
Source contract: `.altitude/contracts/altitude/al-icon-send.contract.json`.
