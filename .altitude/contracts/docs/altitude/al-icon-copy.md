<!-- GENERATED by scripts/contracts/build-component-docs.mjs from al-icon-copy.contract.json + the altitude parity manifest — do not hand-edit; run `pnpm contracts:docs` -->

# al-icon-copy — Icon Copy
...
No Figma component set is mapped for `al-icon-copy` in the **Altitude Design System** parity manifest (parity status: `missing-in-figma`). Map one in Figma, then run `pnpm run parity:seed`.
...
- Import: `@southleft/al-web-components/components/icon/icons/copy.ts`
- Tag: `al-icon-copy`
...
Source contract: `.altitude/contracts/altitude/al-icon-copy.contract.json`.
