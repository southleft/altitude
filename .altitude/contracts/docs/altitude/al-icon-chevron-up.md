<!-- GENERATED by scripts/contracts/build-component-docs.mjs from al-icon-chevron-up.contract.json + the altitude parity manifest — do not hand-edit; run `pnpm contracts:docs` -->

# al-icon-chevron-up — Icon Chevron Up
...
No Figma component set is mapped for `al-icon-chevron-up` in the **Altitude Design System** parity manifest (parity status: `missing-in-figma`). Map one in Figma, then run `pnpm run parity:seed`.
...
- Import: `@southleft/al-web-components/components/icon/icons/chevron-up.ts`
- Tag: `al-icon-chevron-up`
...
Source contract: `.altitude/contracts/altitude/al-icon-chevron-up.contract.json`.
