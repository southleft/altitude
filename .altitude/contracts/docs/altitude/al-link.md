<!-- GENERATED by scripts/contracts/build-component-docs.mjs from al-link.contract.json + the altitude parity manifest — do not hand-edit; run `pnpm contracts:docs` -->
...
- Component set: **Link**
- Node id: `3579:9902` (pinned)
- [Open in Figma](https://www.figma.com/design/y83n4o9LOGs74oAoguFcGS/?node-id=3579-9902)
...
Source contract: `.altitude/contracts/altitude/al-link.contract.json`.
