<!-- GENERATED by scripts/contracts/build-component-docs.mjs from al-checkbox-group.contract.json + the altitude parity manifest — do not hand-edit; run `pnpm contracts:docs` -->

# al-checkbox-group — Checkbox Group
...
| Name | Description |
| --- | --- |
| `onCheckboxGroupChange` | Fired when any checkbox in the group changes. Detail: `{ checked, value, checkedValues }` — the state and value of the checkbox that changed, plus the values of every currently-checked checkbox in the group. |
...
- Import: `@southleft/al-web-components/components/checkbox-group/checkbox-group.ts`
- Tag: `al-checkbox-group`
- Workspace: `@southleft/al-web-components`

## Tokens referenced (15)

`--al-base-space`, `--al-theme-border-radius-lg`, `--al-theme-border-radius-round`, `--al-theme-border-radius-xs`, `--al-theme-border-width`, `--al-theme-color-background-transparent-default`, `--al-theme-color-border-default`, `--al-theme-color-content-default`, `--al-theme-color-content-default-weak`, `--al-theme-space-xs`, `--al-theme-space-xxs`, `--al-theme-typography-body-md`, `--al-theme-typography-body-md-letter-spacing`, `--al-theme-typography-body-sm`, `--al-theme-typography-body-sm-letter-spacing`

---

Source contract: `.altitude/contracts/altitude/al-checkbox-group.contract.json`.
