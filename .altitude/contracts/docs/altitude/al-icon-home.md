<!-- GENERATED by scripts/contracts/build-component-docs.mjs from al-icon-home.contract.json + the altitude parity manifest — do not hand-edit; run `pnpm contracts:docs` -->

# al-icon-home — Icon Home
...
No Figma component set is mapped for `al-icon-home` in the **Altitude Design System** parity manifest (parity status: `missing-in-figma`). Map one in Figma, then run `pnpm run parity:seed`.
...
- Import: `@southleft/al-web-components/components/icon/icons/home.ts`
- Tag: `al-icon-home`
...
Source contract: `.altitude/contracts/altitude/al-icon-home.contract.json`.
