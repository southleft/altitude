<!-- GENERATED by scripts/contracts/build-component-docs.mjs from al-icon-document.contract.json + the altitude parity manifest — do not hand-edit; run `pnpm contracts:docs` -->

# al-icon-document — Icon Document
...
No Figma component set is mapped for `al-icon-document` in the **Altitude Design System** parity manifest (parity status: `missing-in-figma`). Map one in Figma, then run `pnpm run parity:seed`.
...
- Import: `@southleft/al-web-components/components/icon/icons/document.ts`
- Tag: `al-icon-document`
...
Source contract: `.altitude/contracts/altitude/al-icon-document.contract.json`.
