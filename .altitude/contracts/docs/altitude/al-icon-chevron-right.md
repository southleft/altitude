<!-- GENERATED by scripts/contracts/build-component-docs.mjs from al-icon-chevron-right.contract.json + the altitude parity manifest — do not hand-edit; run `pnpm contracts:docs` -->

# al-icon-chevron-right — Icon Chevron Right
...
No Figma component set is mapped for `al-icon-chevron-right` in the **Altitude Design System** parity manifest (parity status: `missing-in-figma`). Map one in Figma, then run `pnpm run parity:seed`.
...
- Import: `@southleft/al-web-components/components/icon/icons/chevron-right.ts`
- Tag: `al-icon-chevron-right`
...
Source contract: `.altitude/contracts/altitude/al-icon-chevron-right.contract.json`.
