<!-- GENERATED by scripts/contracts/build-component-docs.mjs from al-icon-list.contract.json + the altitude parity manifest — do not hand-edit; run `pnpm contracts:docs` -->

# al-icon-list — Icon List
...
No Figma component set is mapped for `al-icon-list` in the **Altitude Design System** parity manifest (parity status: `missing-in-figma`). Map one in Figma, then run `pnpm run parity:seed`.
...
- Import: `@southleft/al-web-components/components/icon/icons/list.ts`
- Tag: `al-icon-list`
...
Source contract: `.altitude/contracts/altitude/al-icon-list.contract.json`.
