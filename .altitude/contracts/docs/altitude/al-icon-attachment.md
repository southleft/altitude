<!-- GENERATED by scripts/contracts/build-component-docs.mjs from al-icon-attachment.contract.json + the altitude parity manifest — do not hand-edit; run `pnpm contracts:docs` -->

# al-icon-attachment — Icon Attachment
...
No Figma component set is mapped for `al-icon-attachment` in the **Altitude Design System** parity manifest (parity status: `missing-in-figma`). Map one in Figma, then run `pnpm run parity:seed`.
...
- Import: `@southleft/al-web-components/components/icon/icons/attachment.ts`
- Tag: `al-icon-attachment`
...
Source contract: `.altitude/contracts/altitude/al-icon-attachment.contract.json`.
