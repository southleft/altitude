...
`@southleft/al-web-components`. Functions as an acceptance test for every refactor
...
```bash
pnpm --filter @southleft/al-web-components build         # produce the dist this app imports
