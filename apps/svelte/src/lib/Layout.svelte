...
// @ts-nocheck
  ...
  import 'al-web-components/components/breadcrumbs-item';
  import 'al-web-components/components/breadcrumbs';
  ...
  import 'al-web-components/components/icon/icons/dots-vertical';
  import 'al-web-components/components/icon/icons/help';
  import 'al-web-components/components/icon/icons/menu';
