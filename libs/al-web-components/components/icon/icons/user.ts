 ...
 * Icon: al-icon-user
 */
export class ALIconUser extends ALElement {
  static el = 'al-icon-user';
...
if ((globalThis as any).alAutoRegistry === true && customElements.get(ALIconUser.el) === undefined) {
  customElements.define(ALIconUser.el, ALIconUser);
}

declare global {
  interface HTMLElementTagNameMap {
    'al-icon-user': ALIconUser;
  }
}
