...
const Template = (args) => html`
  <al-text-passage ${spread(args)}>
    ...
    <p>
      <al-link href="#">Lorem ipsum dolor sit amet</al-link>, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut
