...
const Template = (args) => html`<al-menu-item ${spread(args)} data-testid="menu-item">Menu Item</al-menu-item>`;

const TemplateWithIcon = (args) => html`
  <al-menu-item ${spread(args)} data-testid="menu-item">
    <al-icon-add slot="before"></al-icon-add>
    Menu Item
  </al-menu-item>
`;
