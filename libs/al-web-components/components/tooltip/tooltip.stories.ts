...
Default.play = async ({ canvasElement }) => {
  ...
  const tooltipTrigger = tooltip.shadowRoot.querySelector('.al-c-tooltip__trigger') as HTMLElement;
...
PositionDynamic.play = async ({ canvasElement }) => {
  ...
  const tooltip1Trigger = tooltips[0].shadowRoot.querySelector('.al-c-tooltip__trigger') as HTMLElement;
  const tooltip2Trigger = tooltips[1].shadowRoot.querySelector('.al-c-tooltip__trigger') as HTMLElement;
  const tooltip3Trigger = tooltips[2].shadowRoot.querySelector('.al-c-tooltip__trigger') as HTMLElement;
  const tooltip4Trigger = tooltips[3].shadowRoot.querySelector('.al-c-tooltip__trigger') as HTMLElement;
...
VisibleOnClick.play = async ({ canvasElement }) => {
  const canvas = within(canvasElement);
  const tooltip = canvas.queryByTestId('tooltip') as any;
  const tooltipTrigger = tooltip.shadowRoot.querySelector('.al-c-tooltip__trigger') as any;
