 ...
 */
export class ALSpinner extends ALElement {
  static el = 'al-spinner';
  ...
  render() {
    const componentClassNames = this.componentClassNames('al-c-spinner', {
      'al-c-spinner--small': this.small === true,
      'al-c-spinner--inverted': this.inverted === true
    });
...
if ((globalThis as any).alAutoRegistry === true && customElements.get(ALSpinner.el) === undefined) {
  customElements.define(ALSpinner.el, ALSpinner);
}

declare global {
  interface HTMLElementTagNameMap {
    'al-spinner': ALSpinner;
  }
}
