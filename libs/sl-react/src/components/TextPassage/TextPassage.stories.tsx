  ...
  args: {
    children: (
      <>
        ...
        <p>
          <SLLink href="#">Lorem ipsum dolor sit amet</SLLink>, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.
...
export const Default: StoryObj<typeof SLTextPassage> = { args: {} };

export const MaxWidthSm: StoryObj<typeof SLTextPassage> = {
  args: {
    maxWidth: 'sm'
  }
};