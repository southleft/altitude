...
export class SLDatetimepickerField extends SLElement {
  static el = 'sl-datetimepicker-field';
   ...
   * Query the popup
   */
  @query('.sl-c-datetimepicker-field__popup')
  accessor popup: HTMLElement;

  /**
   * Query the time selector
   */
  @query('.sl-c-datetimepicker-field__time-selector-list')
  ...
  handleOnChangeTime(e: CustomEvent) {
    ...
    if (this.selectedDate) {
      ...
      /* 3 */
      setTimeout(() => {
        this.shadowRoot.querySelector('.sl-c-datetimepicker-field__footer-submit').shadowRoot.querySelector<HTMLButtonElement>('button').focus();
      }, 1);
    } else {
  ...
  /**
   * Close datetimepicker when Cancel button is clicked
  ...
  /**
   * Apply the values and close datetimepicker
  ...
  render() {
    const componentClassNames = this.componentClassNames('sl-c-datetimepicker-field', {
      ...
      'sl-c-datetimepicker-field--small-screen': this.isSmallScreen
    });
        ...
        <div class="sl-c-datetimepicker-field__body">
          ...
          <div class="sl-c-datetimepicker-field__popup" ?hidden="${!this.isActiveCalendar}" role="dialog">
            <div class="sl-c-datetimepicker-field__popup-body">
              ...
              <div class="sl-c-datetimepicker-field__footer">
                <${this.buttonGroupEl} alignment="right">
                  <${this.buttonEl}
                    class="sl-c-datetimepicker-field__footer-cancel"
                    variant="secondary"
                    @click=${this.handleOnClickCancel}
                    >${this.cancelLabel}</${this.buttonEl}>
                  <${this.buttonEl}
                    class="sl-c-datetimepicker-field__footer-submit"
...
if ((globalThis as any).enAutoRegistry === true && customElements.get(SLDatetimepickerField.el) === undefined) {
  customElements.define(SLDatetimepickerField.el, SLDatetimepickerField);
}

declare global {
  interface HTMLElementTagNameMap {
    'sl-datetimepicker-field': SLDatetimepickerField;
  }
}
