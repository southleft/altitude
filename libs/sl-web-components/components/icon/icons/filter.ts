 ...
 * Icon: sl-icon-filter
 */
export class SLIconFilter extends SLElement {
  static el = 'sl-icon-filter';
...
if ((globalThis as any).slAutoRegistry === true && customElements.get(SLIconFilter.el) === undefined) {
  customElements.define(SLIconFilter.el, SLIconFilter);
}

declare global {
  interface HTMLElementTagNameMap {
    'sl-icon-filter': SLIconFilter;
  }
}
