...
/**
 * Icon: sl-icon-bookmark
 */
export class SLIconBookmark extends SLElement {
  static el = 'sl-icon-bookmark';
...
if ((globalThis as any).slAutoRegistry === true && customElements.get(SLIconBookmark.el) === undefined) {
  customElements.define(SLIconBookmark.el, SLIconBookmark);
}

declare global {
  interface HTMLElementTagNameMap {
    'sl-icon-bookmark': SLIconBookmark;
  }
}
