...
/**
 * Icon: sl-icon-sign-in
 */
export class SLIconSignIn extends SLElement {
  static el = 'sl-icon-sign-in';
...
if ((globalThis as any).slAutoRegistry === true && customElements.get(SLIconSignIn.el) === undefined) {
  customElements.define(SLIconSignIn.el, SLIconSignIn);
}

declare global {
  interface HTMLElementTagNameMap {
    'sl-icon-sign-in': SLIconSignIn;
  }
}
