...
/**
 * Icon: sl-icon-layout-masonry
 */
export class SLIconLayoutMasonry extends SLElement {
  static el = 'sl-icon-layout-masonry';
...
if ((globalThis as any).slAutoRegistry === true && customElements.get(SLIconLayoutMasonry.el) === undefined) {
  customElements.define(SLIconLayoutMasonry.el, SLIconLayoutMasonry);
}

declare global {
  interface HTMLElementTagNameMap {
    'sl-icon-layout-masonry': SLIconLayoutMasonry;
  }
}
