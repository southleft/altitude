...
import SignOut from '../svgs/sign-out.svg';

/**
 * Icon: sl-icon-sign-out
 */
export class SLIconSignOut extends SLElement {
  static el = 'sl-icon-sign-out';
...
if ((globalThis as any).slAutoRegistry === true && customElements.get(SLIconSignOut.el) === undefined) {
  customElements.define(SLIconSignOut.el, SLIconSignOut);
}

declare global {
  interface HTMLElementTagNameMap {
    'sl-icon-sign-out': SLIconSignOut;
  }
}
