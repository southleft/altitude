 ...
 * Icon: sl-icon-clock
 */
export class SLIconClock extends SLElement {
  static el = 'sl-icon-clock';
...
if ((globalThis as any).slAutoRegistry === true && customElements.get(SLIconClock.el) === undefined) {
  customElements.define(SLIconClock.el, SLIconClock);
}

declare global {
  interface HTMLElementTagNameMap {
    'sl-icon-clock': SLIconClock;
  }
}
