 ...
 * Icon: sl-icon-bell
 */
export class SLIconBell extends SLElement {
  static el = 'sl-icon-bell';
...
if ((globalThis as any).slAutoRegistry === true && customElements.get(SLIconBell.el) === undefined) {
  customElements.define(SLIconBell.el, SLIconBell);
}

declare global {
  interface HTMLElementTagNameMap {
    'sl-icon-bell': SLIconBell;
  }
}
