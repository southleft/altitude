 ...
 */
export class SLIconSupport extends SLElement {
  static el = 'sl-icon-support';
...
if ((globalThis as any).slAutoRegistry === true && customElements.get(SLIconSupport.el) === undefined) {
  customElements.define(SLIconSupport.el, SLIconSupport);
}

declare global {
  interface HTMLElementTagNameMap {
    'sl-icon-support': SLIconSupport;
  }
}
