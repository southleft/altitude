...
export class SLFileUpload extends SLElement {
  ...
  render() {
    const componentClassNames = this.componentClassNames('sl-c-file-upload', {
      'sl-is-dragging': this.isDragging === true,
    ...
    return html`
      <div class="${componentClassNames}">
        <label class="sl-c-file-upload__label" for="${this.fieldId}">${this.label}</label>
        <div
          class="sl-c-file-upload__body"
        ...
        <ul class="sl-c-file-upload__list">
          ${this.filesState?.map(
            (file: any) => html`
            <li class="sl-c-file-upload__item">
              <div class="sl-c-file-upload__item-body">
                <div class="sl-c-file-upload__item-first">
                  <${this.iconDocumentEl} class="sl-c-file-upload__icon"></${this.iconDocumentEl}>
                  <span class="sl-c-file-upload__item-text">${file.fileObject[1].name}</span>
                </div>
                <div class="sl-c-file-upload__item-second">
                  ${
                    file.status === 'Success'
                      ? html`
                        <div class="sl-c-file-upload__status">
                  ...
                  <${this.buttonEl}
                    class="sl-c-file-upload__close-button"
                    variant="tertiary"
                    ?hideText=${true}
                    type="button"
              ...
              ${
                file.status === 'Uploading'
                  ? html`
                    <div class="sl-c-file-upload__status-uploading">
              ...
              ${
                file.status === 'Failed' && file.fileSizeExceeded && !file.fileFormatError
                  ? html`
                    <${this.fieldNoteEl} ?isError=${true} class="sl-c-file-upload__status-text">
