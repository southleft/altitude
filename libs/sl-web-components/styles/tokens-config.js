  ...
  formatter: function ({ dictionary, options }) {
    ...
    const otherVariables = dictionary.allTokens
      ...
      .map(token => {
        ...
        /* 5 */
        else if (token.name.includes('space')) {
          name = token.name;
...
/**
 * SCSS Breakpoint Variable Formatting
 ...
 */
StyleDictionary.registerFormat({
  name: 'scss/variables-breakpoints',
  formatter: function ({ dictionary, options }) {
    ...
    platforms: {
      scss: {
        ...
        files: [
          ...
          {
            destination: `/styles/core/breakpoints.scss`,
            format: 'scss/variables-breakpoints',
            options: {
              outputReferences: true,
            },
          },
