...
${link('Token source', 'libs/al-web-components/styles/tokens', 'the hand-authored Tokens Studio tree everything else is built from — including the DTCG mirror, which is generated')}
...
\`${wcPackage.name}/tokens-dtcg/*\` is the same story: the DTCG mirror of the token
source is generated into \`styles/tokens-dtcg/\`, is not tracked, and ships in the
package.
