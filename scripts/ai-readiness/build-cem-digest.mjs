...
const DO_NOT_FLAG = {
  ...
  'al-stat-card': [
    ...
    },
    {
      ...
      rule: 'A consumed `--al-theme-*` token (e.g. --al-theme-color-content-neutral-default) is NOT a @cssproperty of the component that reads it. Do NOT flag the absence of @cssproperty entries for global theme tokens; only the component\'s own --al-<component>-* override hooks are @cssproperty.',
      severity: 'do-not-flag',
