...
- The Skill.md contains a link that points to `.mm/standards/...` — Follow that link and read its contents.
...
- You can link to other files (like your standards files in `.mm/standards/`) using markdown links.
