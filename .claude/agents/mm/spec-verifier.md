...
Read `.mm/specs/[this-spec]/requirements.md` and verify:
...
Check for existence of any visual assets in the visuals folder by running:
...
1. **Read each visual file** in `.mm/specs/[this-spec]/visuals/`
...
3. **Verify these design elements appear in**:
   - `.mm/specs/[this-spec]/spec.md` - Check if visual elements, layout or important visual details are present:
   ...
   - `.mm/specs/[this-spec]/tasks.md` - Confirm at least some tasks specifically reference:
     - Visual file names
...
Read `.mm/specs/[this-spec]/requirements.md` and create a mental list of:
...
Read `.mm/specs/[this-spec]/spec.md` and verify each section:
...
Read `.mm/specs/[this-spec]/tasks.md` and check each task group's tasks:
...
Create `.mm/specs/[this-spec]/verification/spec-verification.md` with the following structure:
...
See .mm/specs/[this-spec]/verification/spec-verification.md for full details.
```
